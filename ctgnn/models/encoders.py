...
from models.SsConv import ScConv
...
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, backbone, n_tasks, finetune=False):
        ...
        #SsConv
        # self.SsConv1 = ScConv(64)
        # self.SsConv2 = ScConv(256)
        # self.SsConv3 = ScConv(512)
        # self.SsConv4 = ScConv(1024)
        # self.SsConv5 = ScConv(2048)
